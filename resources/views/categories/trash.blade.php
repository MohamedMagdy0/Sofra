    ...
    <section class=" ">
        <div class="card">
            <div class="card-header text-center">
                <h3> الاقسام المحذوفة : {{ count($categories) }}</h3>
            </div><!-- card-header -->
                        ...
                        <tbody>
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>{{ $category->name }}</td>
                                    <td><a href="{{ route('category.restore', ['id' => $category->id]) }}"
                                            class="btn btn-sm btn-success">ارجاع</a></td>

                                    <td>

                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#modal-default{{ $category->id }}"> حذف</button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-danger">
                                                            <p>هل انت متأكد هل تريد حذف البيانات : <span
                                                                    class="text-primary">{{ $category->name }}</span> <br>
